...
const HeaderImageWithText = ({
    ...
    <div className="relative">
        ...
        >
            ...
            <Header level={2} additionalClasses={['block text-white font-normal !text-2xl md:!text-6xl !p-0 mb-1 md:mb-3']}>
                {headerText2}
            </Header>
            <Header level={2} additionalClasses={['block text-white font-normal !text-2xl md:!text-6xl !p-0']}>
                {headerText3}
            </Header>
        </div>
